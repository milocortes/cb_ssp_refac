...
SSP_RESULTS_DATA_PATH = build_path([CB_REFAC_DATA_PATH, "ssp_model_results", "iran_tornado"])
...
data_filename = build_path([SSP_RESULTS_DATA_PATH, "iran.zip"] )
...
actualiza_claves_tx  = {'TX:AGRC:EXPAND_CONSERVATION_AGRICULTURE' : 'TX:AGRC:INC_CONSERVATION_AGRICULTURE',
 ...
 'TX:GNRL:DEC_RED_MEAT_CONSUMPTION' : 'TX:PFLO:INC_HEALTHIER_DIETS'}
...
for id_tx in ssp_strategy_definition_james.iloc[74:].strategy_code.unique():
...
mapp_id2codename = {i:j for i,j in run_attributes[["strategy_id", "strategy_code"]].to_records(index = False)}
...
#Write
CB_OUTPUT_FILENAME = build_path([OUTPUT_PATH, "cost_benefit_results_tornado.csv"])
