...
SSP_RESULTS_PATH = build_path([DIR_PATH,"ssp_results", "lousiana"])
...
### Directorio de datos requeridos paragenerar el archivo lousiana_plot_data_QA_QC.csv
INPUT_LOUSIANA_QA_PATH = build_path([DIR_PATH, "input_data_lousiana_QA"])

### Directorio de salidas del archivo lousiana_plot_data_QA_QC.csv
OUTPUT_LOUSIANA_QA_PATH = build_path([DIR_PATH, "output_lousiana_QA", "qa"])
OUTPUT_LOUSIANA_CB_PATH = build_path([DIR_PATH, "output_lousiana_QA", "cb"])
...
q = (
    pl.scan_csv(os.path.join(SSP_RESULTS_PATH, "louisiana.csv"), ignore_errors=True)
    .filter(
